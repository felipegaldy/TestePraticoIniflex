...
public class Principal {
	...
	public static void main(String[] args) {
		...
		funcionario5.setDataNascimento(LocalDate.of(1995,01,05));
		...
		funcionario6.setDataNascimento(LocalDate.of(1999,11,19));
		...
		funcionario7.setDataNascimento(LocalDate.of(1993,03,31));
		...
		funcionario8.setDataNascimento(LocalDate.of(1994,07,8));
		...
		funcionario9.setDataNascimento(LocalDate.of(2003,05,24));
		...
		funcionario10.setDataNascimento(LocalDate.of(1996,9,2));
		...
		//imprimindo todos os funcinarios com todas informações
		System.out.println("====LISTA DE FUNCIONARIOS====");
		for(Funcionario i: listaFuncionarios) {
			System.out.println(i);
			//não soube como exibir a data no formato dd/mm/aaaa
			//LocalDate ld = LocalDate.parse(data, DateTimeFormatter.ofPattern("dd/MM/yyyy"));
			// DateTimeFormatter formatador = DateTimeFormatter.ofPattern("dd/MM/yyyy");
			//não soube como exibir salario no formato 1.000,00
		}
